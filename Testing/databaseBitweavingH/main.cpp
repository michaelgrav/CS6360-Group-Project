...
//    }
//
//    // Adds a value into the data vector. This method is simplified and assumes perfect fit scenarios.
...
//            data.push_back(0); // Ensure enough space
//        }
//
...
//    }
//
//    // A simple scan that prints values less than a given threshold
...
//
//int main() {
//    BitWeavingH bwh(3); // 3 bits per value
//
//    // Adding values: 1 (001), 4 (100), 7 (111), 2 (010), 5 (101)
//    bwh.addValue(1);
//    bwh.addValue(4);
//    bwh.addValue(7);
//    bwh.addValue(2);
//    bwh.addValue(5);
//
//    // Perform a scan for values less than 4 (100)
//    bwh.scanLessThan(4);
//
//    return 0;
//}
...
int main() {
    ...
    bwh.readValuesFromFile("/Users/yuliang/CLionProjects/databaseBitweavingH/donations-compressed-reg-int"); // Ensure the filename matches your actual data file
